...
TOTAL_USER = os.environ.get('TOTAL_USERS', '5680454765',1734697126',7269343904').split(',')
TOTAL_USERS = [int(user_id) for user_id in TOTAL_USER]

AUTH_USER = os.environ.get('AUTH_USERS', '5680454765',1734697126',7269343904').split(',')
